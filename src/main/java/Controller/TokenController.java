...
public class TokenController {
    ...
    public static String codeByGrantTypeCodeFlow(Application app){
        String code=new String();
        HttpClient client = HttpClientBuilder.create().build();
        try {
            String url_grant_codes= URL.url_grant_codes+"?"+"client_id="+app.getClient_id()+"&redirect_uri="+app.getRedirect_uri()+"&response_type=code&scope="+ URLEncoder.encode(app.getScope(), "UTF-8");
